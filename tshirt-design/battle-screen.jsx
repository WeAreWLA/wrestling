...
// Charizard — front 3/4 enemy sprite (48 wide), Game Boy style: a black
// outline with a white body and dithered shading rather than a solid
// silhouette. Horned head with a snout, two gray-membraned wings,
// clawed limbs and a flame-tipped tail. '#' ink, '+'/' :' dither tones.
// Drawn at 2x resolution and rendered at half scale (see BattleScreen).
const DRAGON_SPRITE = [
  '......................#.......##................',
  '.....................###.....##.................',
  '.....................#.#.....##.................',
...
// behind (48 wide), Game Boy style: black outline, white muscle with
// dithered shading. Long hair down a V-tapered muscular back, big
// arms, a championship belt with a buckle, and broad legs. Drawn at
// 2x resolution and rendered at half scale (see BattleScreen).
...
function PixelSprite({ grid, scale = 1, flip = false }) {
  ...
  for (let y = 0; y < rows; y++) {
    for (let x = 0; x < cols; x++) {
      // '#' solid ink · '+' 50% dither · ':' 25% dither · '.' bare shirt.
      // Dither is resolved per-cell so a single-colour print still reads
      // as shaded Game Boy-style artwork.
      const ch = grid[y][x];
      let on = false;
      if (ch === '#') on = true;
      else if (ch === '+') on = (x + y) % 2 === 0;
      else if (ch === ':') on = x % 2 === 0 && y % 2 === 0;
      if (on) {
        rects.push(
